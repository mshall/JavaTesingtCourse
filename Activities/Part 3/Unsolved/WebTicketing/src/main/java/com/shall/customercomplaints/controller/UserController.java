...
public class UserController {
	...
	public ResponseEntity<ResponseVO<Iterable<User>>> getAllUsers() {
		return ResponseEntity.ok(new ResponseVO<>(Constants.SUCCESS_CODE, "Ok", ((UserService) service).getAllUsers()));
	}
	...
	public ResponseEntity<ResponseVO<Iterable<User>>> getAllUsersByStatus(@PathVariable("status") int status) {
		return ResponseEntity.ok(new ResponseVO<>(Constants.SUCCESS_CODE, "Ok", ((UserService) service).getAllUsersByStatus(status)));
	}
	...
	public ResponseEntity<ResponseVO<Iterable<User>>> getAllUsersOfType(@PathVariable("userType") int userType) {
		return ResponseEntity.ok(new ResponseVO<>(Constants.SUCCESS_CODE, "Ok", ((UserService) service).getAllUsersOfType(userType)));
	}
	...
	public ResponseEntity<ResponseVO<Iterable<User>>> getAllRootAdmins() {
		return ResponseEntity.ok(new ResponseVO<>(Constants.SUCCESS_CODE, "Ok", ((UserService) service).getAllUsersOfType(0)));
	}
	...
	public ResponseEntity<ResponseVO<Iterable<User>>> getAllAdmins() {
		return ResponseEntity.ok(new ResponseVO<>(Constants.SUCCESS_CODE, "Ok", ((UserService) service).getAllUsersOfType(1)));
	}
	...
	public ResponseEntity<ResponseVO<Iterable<User>>> getAllTechnicians() {
		return ResponseEntity.ok(new ResponseVO<>(Constants.SUCCESS_CODE, "Ok", ((UserService) service).getAllUsersOfType(2)));
	}
